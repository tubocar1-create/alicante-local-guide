...
import { ArrowLeft, Building2, MapPin, MoonStar, Search, Star, TreePine, X } from "lucide-react";
...
export function BusKnownPicker({ onClose, onUnknown, onSelected, initialLineCode, embedded }: Props) {
  ...
  return (
    ...
    >
      ...
      {step === "line" && (
        <div className="flex min-h-0 flex-1 flex-col justify-between gap-2 overflow-hidden pr-0.5">
          <a

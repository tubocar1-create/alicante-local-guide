...
const OPERATORS: Operator[] = [
  ...
  { id: "wiber",     name: "Wiber",              domain: "wiber.com",             url: "https://www.wiber.com",             profile: "Low cost premiumizado",   airport: true,  shuttle: true,  hours: "07:00–23:00", price: "Medio-bajo",  insurance: "Sí",       franchise: "Sí",       vehicles: "Turismo, SUV",                  vans: "Algunas",      renting: "No", waitTime: "Bajo",       terminalOffice: false, cityOffice: false, transparency: "Alta",       vehicleState: "Muy bueno", incidentRisk: "Bajo" },
            ...
            <tbody>
              {SORTED_OPERATORS.map((op) => (
                ...
                <Td sticky className="px-1.5 py-1 whitespace-nowrap">
                  ...
                  <Td className="whitespace-nowrap"><YesNo value={op.cityOffice} /></Td>

...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { key: "pac", label: "PAC · Punto de Atención Continuada", emoji: "🌙", service_types: ["urgencias"], specialty_any: ["PAC"] },
      { key: "pas", label: "PAS · Punto de Atención Sanitaria", emoji: "🩹", service_types: ["urgencias"], specialty_any: ["PAS"] },

...
const PUBLIC_SYSTEM: Tile[] = [
  ...
  { emoji: "🏨", label: "Centros de salud", sublabel: "Atención primaria", href: "/salud/$categoria", search: undefined, bg: "oklch(0.94 0.07 145)", fg: "oklch(0.45 0.15 150)" },
  { emoji: "🩺", label: "Especialidades", sublabel: "Cardio, traumato, dermato…", href: "/salud/$categoria", bg: "oklch(0.94 0.07 220)", fg: "oklch(0.48 0.16 230)" },
  { emoji: "🚑", label: "Urgencias", sublabel: "SAMU 112, PAC, hospitales", href: "/salud/$categoria", bg: "oklch(0.93 0.10 28)", fg: "oklch(0.50 0.20 28)" },
  { emoji: "🧠", label: "Salud mental", sublabel: "USM y unidades especializadas", href: "/salud/$categoria", bg: "oklch(0.93 0.07 290)", fg: "oklch(0.48 0.16 290)" },
  { emoji: "📋", label: "Administración SIP", sublabel: "Cita previa, tarjeta sanitaria", href: "/salud/$categoria", bg: "oklch(0.94 0.05 80)", fg: "oklch(0.45 0.12 80)" },
];

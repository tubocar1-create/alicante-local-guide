/**
 * SUBUS Alicante — real-time bus arrival info.
 *
 * Each bus stop in Alicante has a 4-digit code printed on the stop's QR sticker.
 * The QR resolves to the official SUBUS Alicante stop page
 * (http://www.subus.es/QR/Alicante/consulta.aspx?p=<code>) which refreshes every 15s.
 */

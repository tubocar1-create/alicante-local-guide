...
// Cartelera oficial Teatro Principal Alicante (temporada ene–jun 2026).
// Scrapeada desde teatroprincipaldealicante.com/programacion/enero-junio-2026/.
// `end` opcional para funciones de larga estancia (ej. Mamma Mia!).
// Los eventos caducados se filtran automáticamente en fetchTeatroPrincipalAgenda().
const TEATRO_PRINCIPAL_2026: Array<{ date: string; end?: string; title: string }> = [
  ...
  { date: "2026-03-01", title: "Clara Ingold" },
  { date: "2026-03-01", title: "Facu Díaz" },
  { date: "2026-03-02", title: "Manual per a ociosos i bruixes de dol" },
  { date: "2026-03-03", title: "@Rita_trobador" },
  { date: "2026-03-04", title: "Shoes" },
  { date: "2026-03-06", title: "Aryel Altamar «Hipnosis de Comedia»" },
  { date: "2026-03-07", title: "KIDS & STORIES «The pied piper of Hamelin»" },
  { date: "2026-03-07", title: "«Magia desde el futuro» Joaquín García y Juan C Linero" },
  { date: "2026-03-08", title: "«Dos payasos con mucha magia» V FESTIVAL DE MAGIA" },
  { date: "2026-03-09", title: "Gorsy Edú «El percusionista»" },
  { date: "2026-03-12", title: "Toronzo Cannon" },
  { date: "2026-03-13", title: "Eva Soriano «Disfrutona»" },
  { date: "2026-03-13", title: "Hovik Keuchkerian «Grito»" },
  { date: "2026-03-14", title: "20 pasos, 20 huellas" },
  { date: "2026-03-14", title: "KIDS & STORIES «The little mermaid»" },
  { date: "2026-03-15", title: "American Buffalo" },
  { date: "2026-03-17", title: "El Consorcio" },
  { date: "2026-03-20", title: "Juan Carlos Ortega «Las noches de Ortega»" },
  { date: "2026-03-21", title: "Las amistades peligrosas" },
  { date: "2026-03-22", title: "Parejas imperfectas" },
  { date: "2026-03-24", title: "L’elisir d’amore" },
  { date: "2026-03-27", title: "Filosofía mundana" },
  { date: "2026-03-28", title: "Gala Lírica 175 años Chapí, zarzuela" },
  { date: "2026-03-28", title: "KIDS & STORIES «Nobody wants to play with me»" },
  { date: "2026-03-29", title: "Pijama para seis" },
  { date: "2026-04-08", title: "Paisajes humanos" },
  { date: "2026-04-09", title: "Fórmula V" },
  { date: "2026-04-11", title: "Volar es humano, aterrizar es divino" },
  { date: "2026-04-12", title: "Constelaciones" },
  { date: "2026-04-17", end: "2026-04-18", title: "Ernesto Sevilla" },
  { date: "2026-04-19", title: "Escape room" },
  { date: "2026-04-20", end: "2026-04-21", title: "Los coles con la OJPA y El Principal" },
  { date: "2026-04-22", title: "Juanpis González" },
  { date: "2026-04-23", title: "La del manojo de rosas" },
  { date: "2026-04-24", title: "Francisco y Tamara" },
  { date: "2026-04-25", end: "2026-04-26", title: "Mejor no decirlo" },
  ...
  { date: "2026-05-07", title: "Paco Candela" },
  { date: "2026-05-08", title: "La mujer rota" },
  { date: "2026-05-09", title: "Las Minas Flamenco Tour" },
  { date: "2026-05-10", title: "Albaladre y Orfeón Cantábile" },
  { date: "2026-05-14", title: "Un monstruo viene a verme" },
  { date: "2026-05-17", title: "La pasión infinita" },
  { date: "2026-05-18", title: "Óscar Esplá en tres movimientos" },
  { date: "2026-05-20", title: "Orquesta Barroca Valenciana" },
  { date: "2026-05-22", title: "La verdad" },
  { date: "2026-05-24", title: "Jordi Merca, yo sobreviví a la EGB" },
  { date: "2026-05-24", title: "No me toques el cuento" },
  { date: "2026-05-27", title: "Hasta el (CH)OCHO-M" },
  { date: "2026-05-28", title: "Dire Straits 40th anniversary" },
  { date: "2026-05-29", title: "Hora Treintaypico, El Show" },
  { date: "2026-05-31", title: "Abbey Road" },
  { date: "2026-06-04", title: "Tubular Bells by Opus One" },
  { date: "2026-06-05", title: "Rafa Maza" },
